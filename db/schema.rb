...
ActiveRecord::Schema.define(version: 20140727151943) do
  ...
  create_table "arch_objects", force: true do |t|
    t.string   "name"
    t.date     "foundation"
    t.string   "status"
    t.datetime "created_at"
  ...
  create_table "arch_objects_styles", force: true do |t|
    t.integer  "arch_object_id"
    t.integer  "style_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "arch_objects_types", force: true do |t|
    t.integer  "arch_object_id"
    t.integer  "type_id"
    t.datetime "created_at"
    t.datetime "updated_at"
